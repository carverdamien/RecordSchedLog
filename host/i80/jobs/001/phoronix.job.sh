...
KERNEL_LOCALVERSIONS=(delayed-placement delayed-placement delayed-placement delayed-placement local-cpuofwaker local-light-cpuofwaker lp lp lp schedlog local local-light ipanema)
LP_VALUES=(100000 150000 300000 n n n 1 2 0 n n n n)
SLP=(y y)
