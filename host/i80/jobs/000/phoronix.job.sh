...
PHORONIXES=(schbench apache-siege rust-prime apache-siege apache-siege apache-siege apache-siege aobench apache build-llvm build-linux-kernel)
PARGUMENTS=(   '6-7'            5          0            4            3            2            1       0      0          0                  0)
