...
KERNEL_LOCALVERSIONS=(delayed-placement delayed-placement delayed-placement local-cpuofwaker local-light-cpuofwaker lp lp lp schedlog local local-light ipanema)
