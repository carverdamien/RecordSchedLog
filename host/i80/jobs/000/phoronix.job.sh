...
PHORONIXES=(schbench apache-siege apache-siege apache-siege apache-siege apache-siege aobench apache build-llvm build-linux-kernel)
PARGUMENTS=(   '7 7'            5            4            3            2            1       0      0          0                  0)
