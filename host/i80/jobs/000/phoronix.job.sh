...
KERNEL_LOCALVERSIONS=(delayed-placement local-cpuofwaker local-light-cpuofwaker lp lp lp schedlog local local-light ipanema)
LP_VALUES=(n n n 1 2 0 n n n n)
SLP=(y y)
