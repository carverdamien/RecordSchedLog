...
# Usage
#   ./barplot.py host input.pkl.gz output_perf.pdf output_energy.pdf
...
benchmarks = { 'i80': [ 'aobench-0', 'apache-0', 'apache-siege-1', 'apache-siege-2',
               ...
               'redha': [ 'aobench-0', 'apache-0', 'apache-siege-1', 'apache-siege-2',
                          ...
                          'build-linux-kernel-0', 'build-llvm-0', 'go-benchmark-1',
                          'go-benchmark-2', 'go-benchmark-3', 'go-benchmark-4',
                          'hackbench-1000', 'kbuild-all-12', 'kbuild-all-24', 'kbuild-all-6',
                          'kbuild-sched-12', 'kbuild-sched-24', 'kbuild-sched-6',
                          'mkl-dnn-7-1', 'mkl-dnn-7-2', 'nas_bt.B-12', 'nas_bt.B-6',
                          'nas_cg.C-12', 'nas_cg.C-6', 'nas_ep.C-12', 'nas_ep.C-6',
                          'nas_ft.C-12', 'nas_ft.C-6', 'nas_lu.B-12', 'nas_lu.B-6',
                          'nas_sp.B-12', 'nas_sp.B-6', 'nas_ua.B-12', 'nas_ua.B-6',
                          'node-octane-1', 'redis-1', 'rust-prime-0', 'schbench-6-7',
                          'scimark2-1', 'scimark2-2', 'scimark2-3', 'scimark2-4',
                          'scimark2-5', 'scimark2-6' ],
}
